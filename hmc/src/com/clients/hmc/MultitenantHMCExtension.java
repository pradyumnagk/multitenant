...
/**
 * Provides necessary meta information about the multitenant hmc extension.
 * 
 * 
 * @version ExtGen v4
 */
public class MultitenantHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MultitenantHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.clients.hmc.locales";
